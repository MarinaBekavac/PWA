...
<body>
	...
	<header>
		...
		<div class="nav-div">
		  ...
		  <?php
			/*session_start();*/
			if (($_SESSION['$uspjesnaPrijava'] == true && $_SESSION['$admin'] == true) || (isset($_SESSION['username'])) && $_SESSION['razina'] == 1)
{
				...
				echo "<h3>".$row['naziv']."</h3>";
						...
						echo "<div class='container'>";
										...
										echo "<div class='row' >";
											...
											$query_articles="SELECT * from articles WHERE kategorija='".$row['naziv']."'";
											$result_articles=mysqli_query($dbc,$query_articles);
											while($row=mysqli_fetch_array($result_articles))
											{
												echo "<div class='col-3'>";
												echo "<a href='clanakAdmin.php?id=".$row['id']."'>";
	 ...
	 {
			echo '<p style="text-align:center">' . $_SESSION['username'] . ' nemate dovoljna prava za pristup ovoj stranici.</p>';
		}
